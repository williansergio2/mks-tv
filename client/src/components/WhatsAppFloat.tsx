/* ============================================================
   MKS TV WhatsApp Float Button — Global floating CTA
   Design: Fixed bottom-right WhatsApp button with pulse
...
export default function WhatsAppFloat() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      >
        <div
          className="px-4 py-2 rounded-xl text-black text-sm font-bold whitespace-nowrap"
          style={{
            background: "#25D366",
