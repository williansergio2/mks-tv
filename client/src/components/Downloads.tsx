...
const apps = [
  {
    ...
    desc: "App premium com interface intuitiva, Para Tvs com Android.",
    recommended: true,
    downloadUrl: "http://aftv.news/1041384",
    color: "#3827F5",
  },
  {
    name: "UniTV",
  ...
  },
  {
    name: "Fire Stick TV",
    icon: "📡",
    platforms: ["Fire Stick TV", "Mi Stick"],
    platformIcon: <Tv size={14} />,
    desc: "Ideal para Mi Stick TV e Fire Stick TV. Interface estilo Netflix.",
    recommended: false,
    downloadUrl: "http://aftv.news/1041384",
    color: "#3827F5",
  },
  {
    ...
    desc: "Perfeito para sistema Android Suporte completo.",
    recommended: false,
    downloadUrl: "http://aftv.news/1041384",
    color: "#7b6fff",
  },
